    ...
    <Dialog open={isOpen} onOpenChange={open => (open ? openModal() : closeModal())}>
      {user ? (
        <button
          type="button"
          onClick={() => openModal()}
          className="overflow-hidden rounded-full ring-offset-background transition hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
          <Image

...
export function FullscreenTurnstileGate({
  ...
  return (
    <div
      ...
      <div
        className="relative w-full max-w-xl rounded-[32px] border border-white/10 bg-zinc-900/95 p-6
                   shadow-[0_30px_120px_rgba(0,0,0,0.55)] md:p-8">
        ...
        <div className="mt-6 space-y-4 rounded-[28px] border border-white/10 bg-white/[0.03] p-4 md:p-5">
          ...
          {status === "verified" ? (
            <p className="text-center text-sm text-emerald-300">Verification complete.</p>
          ) : null}
